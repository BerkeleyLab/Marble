...
\multirow{2}{*}{System Clock} &
 ...
 &
  U20 &
  \multirow{2}{9cm}{U20 is an ultra-low jitter clock generator that provides a 125 MHz clock for the FPGA bank 33 that can operate as a DDR3 reference clock. Additionally, U20 generates 125 MHz clock which is connected to the clock mux. }
   \\
Additional Clock &
  Y3 &
...
User Clock &
  Y6 &
  Si570 - provides variable clock frequencies for 10 MHz to 280 MHz; connected to the clock mux \\
